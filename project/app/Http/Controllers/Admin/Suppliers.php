...
//        dd($supplier);
        ...
        //  }
         return redirect('backend/suppliers');
...
//        return redirect()->back();
        return redirect('backend/suppliers/'.$id.'/profile');
    }
    ...
    public function profile($id)
    {
        ...
        $PageTitleRoute = "suppliers";
        $headerLevelProcessTitle1 = $PageTitle;
        $headerLevelProcessTitle2 = $supplier['name'];
        $buttonsRoutsname = $modelViewName = $PageTitleRoute;

        return View('Admin.suppliers.profile',compact('supplier','PageTitle','buttonsRoutsname','headerLevelProcessTitle1','headerLevelProcessTitle2'));
    }
