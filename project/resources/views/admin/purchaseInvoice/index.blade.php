  ...
  <!-- /.box-body -->
    <div class="box-header clearfix">
     @if( is_permited('PurchaseInvoice','add') == 1 )
      <a href="{{ route('purchaseInvoice.create') }}" class="btn btn-sm btn-info btn-flat pull-right" style="margin-left: 5px;"><i class="fa fa-plus"></i> {{trans('main.add')}} {{ $singlePageTitle }} </a>
     @endif
    ...
    <!-- include table response -->
     ...
     @endif
      ...
      <div class="table-responsive">
        ...
        @php
         $ths = [trans('main.code') , trans('main.date'),trans('main.supplier_name') ,trans('main.total_price') ,trans('main.options')];
         $tds = $rows;
