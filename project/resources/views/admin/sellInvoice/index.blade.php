  ...
  <!-- /.box-body -->
    <div class="box-header clearfix">
     @if( is_permited('sellInvoice','add') == 1 )
      <a href="{{ route('sellInvoice.create') }}" class="btn btn-sm btn-info btn-flat pull-right" style="margin-left: 5px;"><i class="fa fa-plus"></i> {{ $buttonsRoutsname }} {{ trans('main.add') }} </a>
     @endif
    ...
    <!-- include table response -->
      ...
      <div class="table-responsive">
        ...
        @php
         $ths = [trans('main.code') , trans('main.date'),trans('main.customer_name') ,trans('main.total_price'),trans('main.total_gain') ,trans('main.options')];
         $tds = $rows;
