...
<!-- TABLE: LATEST ORDERS -->
  ...
  <!-- /.box-body -->
    <div class="box-header clearfix">
      ...
      @endphp
      <button type="button" class="btn btn-sm btn-danger btn-flat pull-left" style="margin-left: 5px; font-size: 15px;"> {{ trans('main.total') }}  : {{ round($totalgaainofper,5)}} {{ trans('main.coins.le') }} </button>
    </div>
    <!-- /.box-header -->
...
<div class="row">
    <div class="col-md-12">
      <h3 class="col-md-3"> {{ trans('main.from') }} </h3>
      <h3 class="col-md-3"> {{ trans('main.to') }} </h3>
    ...
    <form action="{{ route('totalgainindex.index') }}" method="GET">
      ...
      <div class="table-responsive">
        ...
        @php
         $ths = [trans('main.code') , trans('main.date'),trans('main.supplier_name') ,trans('main.total_price'),trans('main.total_gain')];
         $tds = $rows;
