...
<!-- TABLE: LATEST ORDERS -->
  ...
  <!-- /.box-body -->
    <div class="box-header clearfix">
      ...
      @if(app('lang') == 'ar')
            <a class="btn btn-lg btn-danger btn-flat pull-left" style="margin-left: 5px;"> {{trans('main.coins.le')}} {{ round($rows->first()['totl_value'],5) }} <span style="font-size: 15px;"> : {{ trans('main.total') }} </span></a>
      @else
            <a class="btn btn-lg btn-danger btn-flat pull-left" style="margin-left: 5px;"> <span style="font-size: 15px;"> {{ trans('main.total') }} : </span> {{ round($rows->first()['totl_value'],5) }} {{trans('main.coins.le')}} </a>
      @endif
    ...
    <!-- include table response -->
      ...
      <div class="table-responsive">
        ...
        @php
         $ths = [trans('main.date'),trans('main.type'),trans('main.value'),trans('main.total_value'), trans('main.invoice_type') ,trans('main.desc')];
         $tds = $rows;
