  ...
  <!-- /.box-body -->
    ...
    <div class="box-body">
      ...
      <div class="table-responsive">
        ...
        @php
          $ths = [trans('main.code') , trans('main.name') ,trans('main.category'), trans('main.quantity') , trans('main.units') ,trans('main.purchase_price') , trans('main.sell_price'), trans('main.barcode')];
          $tds = $rows;
