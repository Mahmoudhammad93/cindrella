<div class="row">
    <div class="col-md-12">
    <form id="filter" action="{{ route($buttonsRoutsname.'.index') }}" method="GET">
        @php

        $input ="code";
        isset($filterData[$input]) ? $inputValue = $filterData[$input] : $inputValue = '';
        filterInputForm(['type' => 'text', 'class' => 'form-control','name' => $input ,'placeholder' => trans('main.code') , 'value' => $inputValue ] , 2 );

        $input ="name";
        isset($filterData[$input]) ? $inputValue = $filterData[$input] : $inputValue = '';
        filterInputForm(['type' => 'text', 'class' => 'form-control','name' => $input ,'placeholder' => trans('main.name') , 'value' => $inputValue ] , 2 );
