...
<!-- TABLE: LATEST ORDERS -->
  ...
  <!-- /.box-body -->
    <div class="box-header clearfix">
      ...
      <a href="{{ route($buttonsRoutsname.'.create') }}" class="btn btn-sm btn-info btn-flat pull-right" style="margin-left: 5px;"><i class="fa fa-plus"></i> {{ trans('main.add') }} {{ $buttonsRoutsname }} ( اضافة )</a>
      @endif
    ...
    <!-- include table response -->
      ...
      <div class="table-responsive">
        ...
        @php
         $ths = [trans('main.name') , trans('main.options')];
         $tds = $rows;
         $tdOnly = ['name'];
        @endphp
