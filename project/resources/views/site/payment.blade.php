                                ...
                                <div class="single-bottom">
                                    <ul>
                                        <li>
                                            ...
                                            <label for="policy"><span></span>By checking this box, I agree to the Terms & Conditions & Privacy Policy.</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
@section('script')
    <script src="{{ asset('site/assets/js/easyResponsiveTabs.js') }}"></script>
    <script>
